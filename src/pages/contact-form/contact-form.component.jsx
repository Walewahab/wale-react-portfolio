      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a href="mailto:alebiosuw@gmail.com" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-danger" title="alebiosuw@gmail.com">
            ...
            <div className="m-2">
              <a href="https://twitter.com/walewahab" target="_blank" rel="noopener noreferrer">
            ...
            <div className="m-2">
              <a href="https://www.facebook.com/walewahab" target="_blank" rel="noopener noreferrer">
